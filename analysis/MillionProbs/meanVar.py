...
meanVarFile = h5py.File("/mnt/talapasShared/MillionQuad2DProbs/0.01,0.01,0.01,0.01/MeanVar.h5", 'a')
finalProbs = h5py.File("/mnt/talapasShared/MillionQuad2DProbs/0.01,0.01,0.01,0.01/FinalProbs.h5", 'a')

files = glob.glob('/mnt/talapasShared/MillionQuad2DProbs/0.01,0.01,0.01,0.01/*.h5')

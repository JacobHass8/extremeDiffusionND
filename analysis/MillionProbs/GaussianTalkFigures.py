...
ax.plot(xvals, gaussian(xvals, mean, var), ls='--', c='k')
fig.savefig("./Figures/GaussianRegimeDist.svg", bbox_inches='tight')
...
fig.savefig("./Figures/GaussianSkew.svg", bbox_inches='tight')
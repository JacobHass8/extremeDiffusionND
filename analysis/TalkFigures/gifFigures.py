...
for t in tqdm(range(maxT)):
    ...
    cbar.ax.set_ylabel(r"$\mathrm{Probability}$", rotation = 270, labelpad=11)
    
    fig.savefig(f"./Figures/GifFigs/Viz{t}.png", bbox_inches='tight')
    ...
    if t == 100:
        ...
        fig.savefig(f"./Figures/GifFigs/NoRadViz{t}.png", bbox_inches='tight')

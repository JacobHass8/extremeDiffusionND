...
ax2.scatter(vs[:-6], skewness, c='b', s=15)
ax2.scatter(vs[:-6], kurtosisVals, c='r', s=15)
ax2.hlines(0, min(vs[:-6]), max(vs[:-6]), ls='--', color='k')
ax2.set_xscale("log")
ax2.set_xlabel(r"$v$")
ax2.set_ylabel(r"$\textcolor{blue}{\mathrm{Skewness}}/\mathrm{Kurtosis}$")

fig.savefig("../Figures/CriticalHist.pdf", bbox_inches='tight')
...
for distName in os.listdir(dir):
    ...
    prefactor = vs[::-1]**2 * expVar / (1 - expVar) / 4 / np.pi * np.log(time[-1])
...
fig.savefig("../Figures/LargeDeviationNoiseVelocity.pdf", bbox_inches='tight')
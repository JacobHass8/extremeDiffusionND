...
meanVarFile = h5py.File("/mnt/talapasShared/LargeVelocity/1,1,1,1/MeanVar.h5", 'a')
finalProbs = h5py.File("/mnt/talapasShared/LargeVelocity/1,1,1,1/FinalProbs.h5", 'a')

files = glob.glob('/mnt/talapasShared/LargeVelocity/1,1,1,1/*.h5')
